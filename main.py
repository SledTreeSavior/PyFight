...
# define the number of frames in each animation
WARRIOR_ANIMATION_STEPS = [10, 8, 1, 7, 7, 3, 7]
WIZARD_ANIMATION_STEPS = [8, 8, 1, 8, 8, 3, 7]

# define the font for the countdown timer and score
...
# function for drawing fighter healthbars
